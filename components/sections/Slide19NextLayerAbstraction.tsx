      ...
      <div className="relative w-full h-full flex flex-col">
        ...
        <div className="flex items-start justify-between px-6 md:px-12 pt-16 md:pt-20 flex-shrink-0 z-10">
          ...
          <motion.div
            ...
            className="hidden md:flex w-[140px] h-[40px] items-center justify-end flex-shrink-0 ml-6"
          >
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12 flex-grow flex flex-col justify-center">
          ...
          {/* Desktop Layout */}
          <div className="hidden lg:grid grid-cols-[1fr_auto_1fr_auto_1fr] gap-8 items-center">
