  ...
  return (
    ...
    >
      <div className="relative w-full h-screen flex flex-col justify-center -mt-20">
        ...
        {/* Center Left: Main Title & Date */}
        <div className="max-w-4xl">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2, duration: 0.8 }}
            className="text-5xl md:text-7xl lg:text-8xl font-semibold leading-tight text-white mb-8 md:mb-12"
          >
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl lg:text-4xl text-white font-light"
          >
            September 2025
          </motion.p>
        </div>
