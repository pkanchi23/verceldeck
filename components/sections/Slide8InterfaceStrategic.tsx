      ...
      <div className="relative w-full min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 pt-16 md:pt-24 pb-24">
          ...
          <div className="relative w-full max-w-6xl mx-auto h-[500px] md:h-[600px]">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-[120px] md:w-[160px]">
              {/* Arrow 1 - New AI Development Stack (closer to pyramid) */}
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 0.5, duration: 0.6 }}
                className="absolute left-[50%] top-[15%] bottom-[10%]"
              >
                {/* Arrow line with gradient animation */}
                <div className="relative h-full">
                  ...
                  <div
                    ...
                    style={{ transform: 'translate(-50%, -50%) rotate(-75deg)', width: '200px' }}
                  >
              ...
              <motion.div
                ...
                className="absolute left-[10%] top-[15%] bottom-[10%]"
              >
                <div className="relative h-full">
                  <svg
                    viewBox="0 0 100 400"
                  ...
                  <div
                    ...
                    style={{ transform: 'translate(-50%, -50%) rotate(-75deg)', width: '220px' }}
                  >
            ...
            {/* Center Column - 3-Tier Pyramid */}
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] md:w-[400px]">
              {/* Top Tier - Front End */}
              <motion.div
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-12 left-1/2 -translate-x-1/2">
                    <p className="text-white font-semibold text-sm whitespace-nowrap">Front End</p>
                  </div>
                </div>
                {/* Right-side capabilities */}
                <div className="absolute right-[-140px] top-1/2 -translate-y-1/2 space-y-1">
                  <div className="border border-zinc-600 rounded-full px-2 py-0.5 bg-black/20">
              ...
              >
                ...
                >
                  ...
                  {/* Tier label */}
                  <div className="absolute top-12 left-1/2 -translate-x-1/2">
                    <p className="text-white font-semibold text-sm whitespace-nowrap">Back End</p>
                  </div>
                </div>
                {/* Right-side capabilities */}
                <div className="absolute right-[-140px] top-1/2 -translate-y-1/2 space-y-1">
              ...
              >
                ...
                >
                  ...
                  {/* Tier label */}
                  <div className="absolute top-12 left-1/2 -translate-x-1/2">
                    <p className="text-white font-semibold text-sm whitespace-nowrap">Infrastructure</p>
                  </div>
                </div>
                {/* Right-side capabilities */}
                <div className="absolute right-[-140px] top-1/2 -translate-y-1/2 space-y-1">
            ...
            <motion.div
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 w-[280px] md:w-[320px]"
            >
              <div className="border border-zinc-700 rounded-2xl p-6 bg-zinc-900/40">
                {/* Bullet 1 */}
                <motion.div
